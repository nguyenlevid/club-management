...
namespace API.Data
{
    public class Seed
    {
            ...
            RoleManager<AppRole> roleManager)
        {
            ...
            await userManager.AddToRolesAsync(admin, new[] {"Admin", "Leader"});
        ...
        public static async Task SeedEvents(DataContext context) {
            ...
            var eventData = await System.IO.File.ReadAllTextAsync("Data/EventSeedData.json");
